...
function bench_gemm(::Type{M}, n) where {M<:MultiFloat}
    ...
    work = 2n^3
    @printf("  GEMM n=%d: streaming=%8.3f ms (%7.1f MFLOP/s), Vec4=%8.3f ms (%5.2fx), Vec8=%8.3f ms (%5.2fx), generic=%8.3f ms, streaming/generic=%5.2fx\n",
            n, 1e3tf, work/tf/1e6, 1e3t4, tf/t4, 1e3t8, tf/t8, 1e3tg, tg/tf)
end
